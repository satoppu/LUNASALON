...
export const INITIAL_CABINETS = [
  { store: "Bellezza", slot: "1", sortOrder: 1, user: "髙木春菜" },
  { store: "Bellezza", slot: "2", sortOrder: 2, user: "小串健治" },
  ...
  { store: "Bellezza", slot: "7/下", sortOrder: 7, user: "髙木春菜" },
  { store: "Forest", slot: "1", sortOrder: 1, user: "髙木春菜" },
  { store: "Forest", slot: "2", sortOrder: 2, user: "齋藤麻希" },
...
export const INITIAL_COUPONS = [
  ...
  { id: "Bx", sortOrder: 2, user: "髙木春菜" },
  { id: "Cx", sortOrder: 3, user: "篠原香奈子" },
  { id: "Dx", sortOrder: 4, user: "後藤佐和子" },
