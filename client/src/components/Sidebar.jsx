import { LayoutDashboard, TrendingUp, Activity, Share2, Users, Contact, History, Settings, CalendarDays, ListChecks } from "lucide-react";
...
export const NAV_ITEMS = [
  ...
  { key: "reference", label: "一覧", icon: ListChecks },
