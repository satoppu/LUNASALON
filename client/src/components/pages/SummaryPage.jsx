    ...
    <>
      <div className="mb-12">
        <div className="flex items-baseline justify-between mb-4 flex-wrap gap-2">
          ...
          <p style={{ fontFamily: FONT_HEAD, color: "#D4A644" }} className="text-sm">
            全期間累計売上:{" "}
      ...
      <div className="flex flex-wrap gap-x-10 gap-y-3 mb-10 px-6 py-4" style={{ background: "#FFFFFF" }}>
        <div>
          <p style={{ fontFamily: FONT_HEAD, color: "#D4A644" }} className="text-2xl font-bold">
          ...
          return (
            <div key={name} style={{ background: "#FFFFFF", borderLeft: `4px solid ${color}` }} className="px-6 py-5">
              <div className="flex items-baseline justify-between mb-3">
                ...
                {meta?.area && (
                  <span style={{ color: "#8F7D6E" }} className="text-xs">
                    {meta.area}
                  </span>
                )}
              </div>
