...
function DailyTrendsTooltip({ active, payload }) {
  ...
  const rows = [
    ...
    { key: "bookingRevenue", labelText: "予売", text: yen(d.bookingRevenue), color: COLOR.予約 },
    { key: "subscriptionRevenue", labelText: "定売", text: yen(d.subscriptionRevenue), color: COLOR.定額 },
    { key: "cancelRevenue", labelText: "消売", text: d.cancelRevenue > 0 ? `-${yen(d.cancelRevenue)}` : yen(0), color: COLOR.取消 },
    { key: "revenue", labelText: "合売", text: yen(d.revenue), color: COLOR.合計 },
  ];
  return (
